        ...
        public void OnEnable()
        {
            ...
            if (animator != null && animator.runtimeAnimatorController == null)
            {
                    ...
                    "Yes", "No"))
                {
                    ...
                    var importer = AssetImporter.GetAtPath(assetPath) as TBGImporter;
                    importer.CreateAnimatorControllerAsset();

                    // Manually mark the editor to have the changes registered, we will manually do the change ourselves.
                    var editor = Editor.CreateEditor(importer) as AssetImporterEditor;
                    editor.SaveChanges();
                    DestroyImmediate(editor);

                    // Perform the work manually that the importer would be doing to take this modification, and skip the entire import step.
                    TBGPostProcessor.ApplyAnimationClipsToAnimatorController(importer, TBGPostProcessor.GetSavedClips(assetPath));
